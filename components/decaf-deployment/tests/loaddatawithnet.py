...
class TestStorageAPI():
    ...
    def test_scenario_insert(self):
        ...
        code, vnf_id1 = self.storage.add(Vnf,{
            'name': 'firewal',
            'description': 'firewal description',
            'path': 'path',
            'public': False
        })
        print('VNF: ', vnf_id1)
        ...
        # create VM
        code, vm_id11 = self.storage.add(Vm,{
            'name': 'firewal',
            'description': 'firewal description',
            'vnf_id': vnf_id1,
            'flavor_id': flavor_id,
        ...
        # create VM
        code, vm_id12 = self.storage.add(Vm,{
            'name': 'firewal',
            'description': 'firewal description',
            'vnf_id': vnf_id1,
            'flavor_id': flavor_id,
        ...
        # add internal Net
        code, net_id1 = self.storage.add(Net, {
            'name': 'name',
            'description': 'description',
            'type': 'data',
            'vnf_id': vnf_id1
        ...
        # add Interface
        code, interface_id111 = self.storage.add(Interface, {
            'name': 'name',
            'description': 'description',
            'type': 'mgmt',
            'internal_name': 'mgmt0',
        ...
        print('INTERFACE: ', interface_id111)

        # add Interface
        code, interface_id112 = self.storage.add(Interface, {
            'name': 'name',
            'description': 'description',
            'type': 'data',
            'internal_name': 'eth0',
        ...
        print('INTERFACE: ', interface_id112)

        # add Interface
        code, interface_id113 = self.storage.add(Interface, {
            'name': 'name',
            'description': 'description',
            'type': 'data',
            'internal_name': 'eth1',
        ...
        print('INTERFACE: ', interface_id113)

        # add Interface
        code, interface_id121 = self.storage.add(Interface, {
            'name': 'name',
            'description': 'description',
            'type': 'mgmt',
            'internal_name': 'mgmt0',
        ...
        print('INTERFACE: ', interface_id121)

        # add Interface
        code, interface_id122 = self.storage.add(Interface, {
            'name': 'name',
            'description': 'description',
            'type': 'data',
            'internal_name': 'eth0',
        ...
        print('INTERFACE: ', interface_id122)

        # add Interface
        code, interface_id123 = self.storage.add(Interface, {
            'name': 'name',
            'description': 'description',
            'type': 'data',
            'internal_name': 'eth1',
        ...
        print('INTERFACE: ', interface_id123)
